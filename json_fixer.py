...
if __name__ == "__main__":
    ds = json.load(open("files/balanced_dataset_fcasciola.json", encoding="UTF8"))
    ...
    json.dump(ds, open("files/balanced_dataset_fcasciola_encfix.json", "w", encoding="UTF8"), ensure_ascii=False)